...
import $ from "jquery"
import { User, AuthState } from "../types/TypeUser";
...
export const getCatalog = (key: string): Promise<any> => {
	return new Promise((resolve, reject) => {
			$.ajax({
					url: `http://127.0.0.1:5001/majoraudit/us-central1/functions/getCatalog?key=${key}`,
					method: "GET",
					xhrFields: { withCredentials: true }
			}).done((data: any) => {
					resolve(data);
