            ...
            <Card.Body>
                ...
                <Card.Text>
                    <p>The Department of Computer Science offers both B.S. and B.A. degree programs, as well as four combined major programs in cooperation with other departments: Electrical Engineering and Computer Science, Computer Science and Economics, Computer Science and Mathematics, and Computer Science and Psychology. Each program not only provides a solid technical education but also allows students either to take a broad range of courses in other disciplines or to complete the requirements of a second major.
                        ...
                        Prospective majors are encouraged to discuss their programs with the director of undergraduate studies (DUS) as early as possible.</p>
                </Card.Text>
            </Card.Body>
        </Card>
    );
