    ...
    metadata: [
        {
            ...
            fall: {
                courses: [
                    { course: { code: "DRST 001", title: "Directed Studies: Literature", seasons: ["FALL", "SPRING"], evaluation: { rating: 4.1, workload: 4.2, professor: 5}, distribution: ["Hu", "WR"] }, enrollmentStatus: "COMPLETED", season: "FALL", year: "2022-2023", letterGrade: "A-" }, 
                    { course: { code: "DRST 001", title: "Directed Studies: Literature", seasons: ["FALL", "SPRING"], evaluation: { rating: 4.1, workload: 4.2, professor: 5}, distribution: ["Hu", "WR"] }, enrollmentStatus: "COMPLETED", season: "FALL", year: "2022-2023", letterGrade: "A-" }, 
                    { course: { code: "DRST 001", title: "Directed Studies: Literature", seasons: ["FALL", "SPRING"], evaluation: { rating: 4.1, workload: 4.2, professor: 5}, distribution: ["Hu", "WR"] }, enrollmentStatus: "COMPLETED", season: "FALL", year: "2022-2023", letterGrade: "A-" }, 
                    { course: { code: "DRST 001", title: "Directed Studies: Literature", seasons: ["FALL", "SPRING"], evaluation: { rating: 4.1, workload: 4.2, professor: 5}, distribution: ["Hu", "WR"] }, enrollmentStatus: "COMPLETED", season: "FALL", year: "2022-2023", letterGrade: "A-" },]
            },
